...
`),e("span",{class:"hljs-tag"},[s("</"),e("span",{class:"hljs-name"},"configuration"),s(">")]),s(`
`)])]),e("p",null,"A few important points regarding this file:"),e("ol",null,[e("li",null,[s("The iisnode handler "),e("code",{class:""},"path"),s(" parameter is set to the entrypoint filepath")]),e("li",null,[s("The iisnode handler "),e("code",{class:""},"verb"),s(" parameter is set to handle all verbs (*)")]),e("li",null,[s("The iisnode "),e("code",{class:""},"node_env"),s(" parameter is bound to the environment variable "),e("code",{class:""},"node_env")]),e("li",null,[s("The iisnode "),e("code",{class:""},"enableXFF"),s(" parameter is set to "),e("code",{class:""},"true"),s(". Since iisnode acts as a reverse proxy, this is required to pass client IP and other details on to the directus server, which directus modules expect and depend on.")]),e("li",null,"The rewrite rule is in place to send all requests made to this site to the entrypoint, ensuring that directus handles the routing and not IIS"),e("li",null,"The error page response needs to be untouched by IIS for two-factor authentication to work.")]),e("p",null,"While there are dozens even hundreds of options within IIS, this should help in getting started with Directus on IIS.")],-1),h={title:"IIS (Internet Information Services)",modularExtension:!1},p={name:"iis",setup(d,{expose:n}){return n({frontmatter:{title:"IIS (Internet Information Services)",modularExtension:!1}}),(u,j)=>{const l=t("docswrapper");return r(),i(l,{frontmatter:h},{default:o(()=>[c]),_:1})}}};typeof a=="function"&&a(p);export{p as default,h as frontmatter};
